...
export const mockPicks: Pick[] = [
  ...
  { id: 'pick-1', bracket_id: 'test-bracket-1', round: 0, match_position: 0, winner_seed: 9, is_correct: null, actual_winner_seed: null, actual_loser_seed: null, created_at: '2026-01-04T00:00:00Z' },
  { id: 'pick-2', bracket_id: 'test-bracket-1', round: 0, match_position: 1, winner_seed: 10, is_correct: null, actual_winner_seed: null, actual_loser_seed: null, created_at: '2026-01-04T00:00:00Z' },
  { id: 'pick-3', bracket_id: 'test-bracket-1', round: 0, match_position: 7, winner_seed: 16, is_correct: null, actual_winner_seed: null, actual_loser_seed: null, created_at: '2026-01-04T00:00:00Z' },
]
